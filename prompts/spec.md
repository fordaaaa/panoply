...
> Turn a feature request into a resumable spec with a checklist on disk, then work it one task at a time
>
> Portable copy-paste version. Replace `{{ARGUMENTS}}` below with your input ([what you want | resume | status]).
