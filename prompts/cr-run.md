...
> Run a parallel multi-subagent code review and report findings by severity, optionally filing them as issues
>
> Portable copy-paste version. Replace `{{ARGUMENTS}}` below with your input ([quick|standard|deep]).
