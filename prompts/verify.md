...
> Check the working diff against a spec's acceptance criteria and the test suite, then write a pass/fail verdict
>
> Portable copy-paste version. Replace `{{ARGUMENTS}}` below with your input ([spec-slug | diff]).
